...
describe('Utils', () => {
  describe('extractAllGetter', () => {
    it('should return only getters, not data properties of ClassTest', () => {
      class ClassTest {
        public a = 'a';
        private _c;
    ...
    it('should return only getters, not methods of ClassTest', () => {
      class ClassTest {
        public get b() {
          return 'b';
        }
    ...
    it('should return only getters which do not return undefined', () => {
      class ClassTest {
        public a = 'a';
